...
public class EditCommandTest extends TodoListGuiTest {
    ...
    public void edit_allFieldsSpecified_success() throws Exception {
        ...
        TestTask editedTask = new TaskBuilder().withTaskName("Burn clothes").withDueDate("182003").withStatus("undone")
    ...
    public void edit_duplicateTask_failure() {
        commandBox.runCommand(
                "edit 3 Assignment for CS2103 d/85355255 s/undone " + "b/123, Jurong West Ave 6, #08-111 t/friends");
